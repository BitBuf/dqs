...
import dev.dewy.dqs.taribone.inventory.ToolType;

import static dev.dewy.dqs.taribone.inventory.ToolType.*;
import static dev.dewy.dqs.taribone.world.block.Material.Flag.*;
...
public enum Material
{
    ...
    Material(int id, ToolType toolType)
    {
        this(id, 64, toolType);
    }

    Material(int id, int flags)
    {
        this(id, flags, 64);
    }

    Material(int id, int flags, ToolType toolType)
    {
        this(id, flags, 64, toolType);
    }

    Material(int id, int flags, int maxStack)
    {
        this(id, flags, maxStack, null);
    }

    Material(int id, int flags, int maxStack, ToolType toolType)
    {
        this.id = id;
        this.flags = flags;
