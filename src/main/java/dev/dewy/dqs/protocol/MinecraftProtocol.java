...
import dev.dewy.dqs.packet.ingame.client.window.*;
import dev.dewy.dqs.packet.ingame.client.world.*;
import dev.dewy.dqs.packet.ingame.server.*;
import dev.dewy.dqs.packet.ingame.server.entity.*;
import dev.dewy.dqs.packet.ingame.server.entity.player.*;
import dev.dewy.dqs.packet.ingame.server.entity.spawn.*;
import dev.dewy.dqs.packet.ingame.server.scoreboard.ServerDisplayScoreboardPacket;
import dev.dewy.dqs.packet.ingame.server.scoreboard.ServerScoreboardObjectivePacket;
import dev.dewy.dqs.packet.ingame.server.scoreboard.ServerTeamPacket;
import dev.dewy.dqs.packet.ingame.server.scoreboard.ServerUpdateScorePacket;
import dev.dewy.dqs.packet.ingame.server.window.*;
