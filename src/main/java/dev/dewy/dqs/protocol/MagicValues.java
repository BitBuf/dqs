...
import dev.dewy.dqs.protocol.game.*;
...
import dev.dewy.dqs.protocol.game.entity.attribute.ModifierType;
import dev.dewy.dqs.protocol.game.entity.metadata.MetadataType;
import dev.dewy.dqs.protocol.game.entity.player.*;
...
import dev.dewy.dqs.protocol.game.entity.type.object.MinecartType;
import dev.dewy.dqs.protocol.game.entity.type.object.ObjectType;
import dev.dewy.dqs.protocol.game.scoreboard.*;
import dev.dewy.dqs.protocol.game.setting.ChatVisibility;
import dev.dewy.dqs.protocol.game.setting.Difficulty;
import dev.dewy.dqs.protocol.game.statistic.GenericStatistic;
import dev.dewy.dqs.protocol.game.window.*;
import dev.dewy.dqs.protocol.game.window.property.AnvilProperty;
import dev.dewy.dqs.protocol.game.window.property.BrewingStandProperty;
import dev.dewy.dqs.protocol.game.window.property.EnchantmentTableProperty;
import dev.dewy.dqs.protocol.game.window.property.FurnaceProperty;
import dev.dewy.dqs.protocol.game.world.Particle;
import dev.dewy.dqs.protocol.game.world.WorldBorderAction;
...
import dev.dewy.dqs.protocol.game.world.effect.ParticleEffect;
import dev.dewy.dqs.protocol.game.world.effect.SmokeEffectData;
import dev.dewy.dqs.protocol.game.world.effect.SoundEffect;
import dev.dewy.dqs.protocol.game.world.map.MapIconType;
import dev.dewy.dqs.protocol.game.world.notify.ClientNotification;
import dev.dewy.dqs.protocol.game.world.notify.DemoMessageValue;
import dev.dewy.dqs.protocol.game.world.notify.EnterCreditsValue;
