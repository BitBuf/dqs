...
import dev.dewy.dqs.utils.nbt.conversion.builtin.*;
import dev.dewy.dqs.utils.nbt.conversion.builtin.custom.*;
import dev.dewy.dqs.utils.nbt.tag.TagRegisterException;
import dev.dewy.dqs.utils.nbt.tag.builtin.*;
import dev.dewy.dqs.utils.nbt.tag.builtin.custom.*;
